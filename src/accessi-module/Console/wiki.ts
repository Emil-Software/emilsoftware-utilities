...
export const WIKI_SECTIONS: WikiSection[] = [
  ...
  // -------------------------------------------------------------------------
  {
    ...
    blocks: [
      ...
      note('info', `Gruppi menu e NOMECAMPO`, `Ogni gruppo menu puo dichiarare NOMECAMPO, la colonna UTENTI_CONFIG che ne regola l'abilitazione (es. FLGDIPENDENTI). get-groups-with-menus e get-menus espongono nomeCampo.`),
