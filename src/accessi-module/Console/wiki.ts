...
export const WIKI_SECTIONS: WikiSection[] = [
  ...
  // -------------------------------------------------------------------------
  {
    ...
    blocks: [
      ...
      note('info', `Gruppi menu e NOMECAMPO`, `Ogni gruppo menu puo dichiarare NOMECAMPO. get-groups-with-menus e get-menus espongono nomeCampo. Dopo la pulizia dello schema NOMECAMPO non deve piu puntare a colonne applicative rimosse.`),
